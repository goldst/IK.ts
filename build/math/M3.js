...
var M3 = /** @class */ (function () {
    ...
    M3.prototype.set = function (n11, n12, n13, n21, n22, n23, n31, n32, n33) {
    ...
    M3.prototype.setV3 = function (xAxis, yAxis, zAxis) {
        var te = this.elements;
        te[0] = xAxis.x;
        te[3] = xAxis.y;
        te[6] = xAxis.z;
    ...
    M3.prototype.createRotationMatrix = function (referenceDirection) {
        var zAxis = referenceDirection; //normalised();
        var xAxis = new V3_1.V3(1, 0, 0);
        var yAxis = new V3_1.V3(0, 1, 0);
    ...
    M3.prototype.rotateAboutAxis = function (v, angle, rotationAxis) {
